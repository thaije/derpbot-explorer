> **Archival reference (frozen 2026-04-08).** Source material for Tasks 1–4 ([#1](https://github.com/thaije/derpbot-explorer/issues/1)–[#4](https://github.com/thaije/derpbot-explorer/issues/4)). Everything actionable has either landed in the repo or is tracked as a GitHub issue — remaining leftovers: [#14](https://github.com/thaije/derpbot-explorer/issues/14), [#15](https://github.com/thaije/derpbot-explorer/issues/15). Do not treat as live truth: values here were deep-research recommendations, not all of which survived verification (e.g. `bond_heartbeat_period` is not exposed on Jazzy, local `cost_scaling_factor=8.0` did not pay back — see [#3](https://github.com/thaije/derpbot-explorer/issues/3), [#5](https://github.com/thaije/derpbot-explorer/issues/5)). Verify against current code + closed issues before acting.
