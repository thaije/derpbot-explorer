...
- **OWL_CONF_THRESHOLD: currently 0.15** — was lowered to 0.10 for exit_sign (low-poly mesh gives <0.10 confidence), but exit_sign is not always a mission target and 0.10 produced 3 FPs in run 20260321T161950. Now at 0.15 as a compromise. If true-positive rate drops for other target classes, lower back to 0.12.
...
| 2026-03-21 patrol+OWL=0.15 | 42 | *in progress* | — | — | — | Patrol mode: after frontier exhaustion, navigate to physically unvisited regions. OWL_CONF raised 0.10→0.15 to reduce FPs |
