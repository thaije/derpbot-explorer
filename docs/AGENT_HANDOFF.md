...
| 2026-03-21 clearance=0.25m soft (no push) | 42 | 54.2 (D) | 3/6 | **100%** | ~1.97 | 5 collisions, 3 FPs! Clearance code changes path selection: finds fire_ext#2 but misses fire_ext#1+person vs 66.1. 5 collisions from meeting room entry (furniture not yet SLAM-mapped). Clearance code REVERTED — pure regression vs 66.1 baseline. |
